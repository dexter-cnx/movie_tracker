    ...
    return SafeArea(
        child: SingleChildScrollView(
            ...
            child:
              ...
              Row(children: [
                Expanded(
                    child: Column(
                        ...
                        children: [
                      Text('welcome'.tr(namedArgs: {'name': 'Dexter'}),
                ...
                const ClayIconButton(icon: Icons.calendar_month_rounded)
              ]),
              ...
              const SizedBox(height: 28),
              _sectionHeader(context, 'myWatchlist'.tr(),
                  action: TextButton(
              ...
              if (watchlist.isEmpty)
                ...List.generate(
                    ...
                    (i) => _watchRow(
                        context,
                        ['Dune: Part Two', 'Inside Out 2', 'The Wild Robot'][i],
                        [
                          'upcoming'.tr(),
                          'watched'.tr(),
                          '60% ${'watched'.tr()}'
                ...
                ...watchlist.take(4).map(
                    (e) => _watchRow(context, e.title, e.status.name.tr())),
            ])));
  }

  Widget _sectionHeader(BuildContext c, String title, {Widget? action}) =>
      Row(children: [
        Expanded(child: Text(title, style: Theme.of(c).textTheme.titleLarge)),
        if (action != null) action
      ]);
  Widget _watchRow(BuildContext c, String title, String status) => Padding(
          ...
          child: Row(children: [
            ...
            Expanded(
                child: Column(
                  ...
                  const SizedBox(height: 4),
                  Text(status, style: Theme.of(c).textTheme.bodyMedium)
                ])),
            Text('${'today'.tr()}: 8:15pm',
